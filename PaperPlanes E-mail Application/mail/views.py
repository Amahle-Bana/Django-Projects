...
def register(request):
    if request.method == "POST":
        ...
        if username == '' or password == '' or email == '' or confirmation == '':
            return render(request, "mail/register.html", {
                "error_message2": "You Forgot To Enter Username, Email, Password Or Confirmation.",
            })
        ...
        try:
            ...
            print(e)
            return render(request, "mail/register.html", {
                "email_message": "Email address already taken."
            })
        login(request, user)
        return HttpResponseRedirect(reverse("index"))
    else:
